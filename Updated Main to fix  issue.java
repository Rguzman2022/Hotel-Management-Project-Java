...
class Hotel
{
    ...
    static List<String> validGender= Arrays.asList("Male","Female","Others");
    static void CustDetails(int i,int rn) throws Exception
    {
    ...
    private static boolean checkContactNo(String contact) {
...
private static void checkGender(String gender) throws Exception {

    if(!validGender.contains(gender))
    {
    System.out.println("Enter valid Gender [Male,Female,Others]");
    throw new Exception();
